        ...
        <AnimatePresence mode="wait">
          ...
          {stage === "result" && primaryProfile && (
            <motion.section className="result-scene playful-result" key="result" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.38, ease: [0.23, 1, 0.32, 1] }}>
              ...
              <section className="practice-callout" aria-label="ลิงก์ทำข้อสอบราชการ"><p>อยากลองทำข้อสอบราชการไหม?</p><a href="https://r2racha.github.io/law-gov/" target="_blank" rel="noreferrer" aria-label="เปิดเว็บไซต์ทำข้อสอบราชการ"><span className="practice-tap"><Hand size={21} /> </span><strong>กดตรงนี้เลย</strong></a></section>
